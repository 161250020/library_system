            ...
            <div class="col-md-9" style="background-color: white;box-shadow: inset 1px -1px 1px #f7ff62, inset -1px 1px 1px #fff626;height: 70%;">
                ...
                <div class="panel panel-default">
                    ...
                    <div style="height: 40px">
                        ...
                        <div class="two">
                            <input type="text" class="form-control" name="book_id" readonly="readonly" value="<%=book.getId()%>">
                        </div>
                    </div>
                        <br>
                    <div style="height: 40px">
                    ...
                    <div style="height: 40px">
                        ...
                        <div class="two">
                            <input type="text" class="form-control" name="book_type" value="<%=book.getType()%>">
                        </div>
                    </div>
                        <br>
                        <div style="height: 40px">
                        ...
                        <div style="height: 40px">
                            ...
                            <div class="two">
                                <input type="text" class="form-control" name="book_publish" value="<%=book.getPublishCompany()%>">
                            </div>
                        </div>
                        <br>
                        <div style="height: 40px">
                            ...
                            <div class="two">
                                <input type="text" class="form-control" name="book_fine" value="<%=book.getFineMoneyPerDay()%>">
                            </div>
                        </div>
                        <br>
                        <div style="height: 40px">
                            ...
                            <div class="two">
                                <input type="text" class="form-control" name="book_state" value="<%=book.getState()%>">
                            </div>
                        </div>
                    <br>
                    <br>
